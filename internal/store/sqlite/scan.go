...
// timestamp column in this schema holds, per "Technical decisions" in
// docs/architecture.md, so a repository writes and reads a Go time directly
// rather than converting by hand on both sides of every column.
