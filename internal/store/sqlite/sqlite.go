...
func (db *DB) Settings() store.SettingsRepository {
	return settingsRepository{q: db.q}
}
...
// Trips implements [store.Store].
func (db *DB) Trips() store.TripRepository {
	return tripRepository{q: db.q}
}
