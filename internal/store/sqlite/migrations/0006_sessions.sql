...
-- credential from users.api_key: a session expires, DELETE
-- /travelmap/web/session destroys it, and one account may hold several at
-- once while the API key is one per user and never expires.
--
