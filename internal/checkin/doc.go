...
// both write through [Write]: they have to agree on how a duplicate is
// recognised and on which fields a repeat write overwrites, and a second
// writer would settle that twice. See "checkins" in docs/database.md for
// what the upsert keeps and what it refreshes.
//
